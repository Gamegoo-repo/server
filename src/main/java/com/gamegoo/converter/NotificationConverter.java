...
public class NotificationConverter {
    ...
    public static NotificationResponse.notificationDTO toNotificationDTO(Notification notification) {
        // notificationType 설정
        ...
        if (notification.getNotificationType().getSourceUrl() != null) {
            StringBuilder urlBuilder = new StringBuilder(notification.getNotificationType().getSourceUrl());
